...
payments_availables = sorted(df['payment_method'].unique())
...
st.header('📈 | Amazon Sales Dashboard')
st.markdown('Explore Amazon Sales 22/23 Data')
st.markdown('---')
...
col1.metric('Item Total Sold', total_sold)
...
tab1, tab2 = st.tabs(['Graphs', 'Data Frame'], width='stretch')
